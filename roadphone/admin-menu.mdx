...
The Admin Menu is an in-game panel that lets you edit RoadPhone's configuration files (`config.lua`, `config.json`, addon configs, and locales) directly from inside FiveM — no manual file editing or FTP uploads required.

<Frame>
  <img src="https://r2.fivemanage.com/72cdX4S6uW7YY845UQgsA/iztjjzttzjage.png" alt="RoadPhone Admin Menu" />
</Frame>
...
<Warning>
  This permission gives full read/write access to RoadPhone's config files on the server filesystem. Only grant it to trusted staff.
</Warning>
