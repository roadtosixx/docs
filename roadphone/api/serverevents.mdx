---
title: 'Server Events'
description: 'All server-side events registered by RoadPhone'
icon: 'radio-tower'
---
...
This page documents every networked server event RoadPhone registers, plus the server-side hooks it emits for other resources.
