---
title: 'Client Events'
description: 'All client-side events registered by RoadPhone'
icon: 'smartphone'
---
...
<Note>
  `clientAPI.lua` and `island.lua` register no networked events — their surfaces are exports and NUI callbacks. The Live Bar Lua API is documented under [Client Exports](/roadphone/api/client).
</Note>
