...
<Note>
  `clientAPI.lua` and `island.lua` register no networked events — their surfaces are exports and NUI callbacks. The Dynamic-Island Lua API is documented under [Client Exports](/roadphone/api/client).
</Note>
