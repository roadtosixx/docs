...
<Info>
  {product} requires a valid **Fivemanage** API key for media storage and management features.
</Info>
...
- Access to edit the {product} resource files

## Configuration Steps

<Steps>
  <Step title="Locate API Configuration">
    Navigate to your {product} resource folder and open `API.lua`.
  </Step>
