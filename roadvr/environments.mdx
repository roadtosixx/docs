...
<Card title="Poly Haven" icon="download" href="https://polyhaven.com/hdris">
  Free, CC0, no attribution required. The two examples already written into
...
<Steps>
  ...
  <Step title="Register it">
    ...
    Config.Environments = {
        list = {
            { id = 'german_town_street', image = 'german_town_street.webp', label = 'Altstadt' },
            { id = 'ushaka_aquarium',    image = 'ushaka_sea_world_aquarium.webp', label = 'Aquarium' },
