...
<Steps>
    ...
    <Step title="Configure API">
        ...
        - Open <code>API.lua</code> and enter your **Fivemanage** or **Fivemerr** API key.
...
<CardGroup cols={2}>
    <Card title="Configuration" icon="gear" href="/configuration">
        Learn how to customize the script settings
    </Card>
    <Card title="Commands" icon="terminal" href="/commands">
        View all available commands and permissions
    </Card>
</CardGroup>