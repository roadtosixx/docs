...
Your endpoint receives the media kind as the query parameter `fileType`:

| File Type | Used By | Example MIME Types |
|-----------|---------|-------------------|
| `image` | Camera, Glimpse, Livestream, Connect, Loop, Quick Settings | `image/png`, `image/jpeg`, `image/webp` |
