...
<Warning>
  **Do not build on these.** RoadID/cloud and social accounts use **server-authoritative sessions**: the account row stores content, and a session token decides who is signed in. These legacy metadata exports do not establish or revoke current sessions.
...
These exports remain for compatibility. They do not establish or revoke a current session; do not use them for login or logout.
