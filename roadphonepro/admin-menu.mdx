...
<AccordionGroup>
  ...
  <Accordion title="Addons" icon="puzzle">
    Lists every addon under `lua-code/addons/*/config.lua` — battery, mechanic, phonebox, roadpods and simcard. Each addon's config is loaded into a separate sub-section so you can configure them independently without leaving the panel.
  </Accordion>
