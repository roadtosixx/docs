...
| Social apps | Wave polls and DMs; Connect replies, reactions and unsending; Glimpse chats and stories | [Accounts](/roadphonepro/accounts) |
...
| Item data | Active-slot handling, buffered writes, backups and account sessions | [Metadata](/roadphonepro/metadata), [Accounts](/roadphonepro/accounts) |
...
4. Add the Fold inventory item or Jaksam metadata using the [Fold guide](/roadphonepro/fold).
...
See [session migration](/roadphonepro/accounts#upgrading-existing-accounts) for existing accounts. Do not clear session tables or item metadata as an update step.
